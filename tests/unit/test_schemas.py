...
from app.schemas.user import UserCreate, UserResponse, UserProfileUpdate, UserProfileResponse
from app.schemas.trip import TripCreate, TripResponse, TripUpdate, TripMemberCreate, TripActivityResponse
